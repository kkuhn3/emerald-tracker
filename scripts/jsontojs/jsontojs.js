...
hiddenBy["key_items"] = [];
hiddenBy["bikes"] = [];
hiddenBy["event_tickets"] = [];
hiddenBy["rods"] = [];
hiddenBy["overworld_items"] = [];
hiddenBy["hidden_items"] = [];
hiddenBy["npc_gifts"] = [];
hiddenBy["berry_trees"] = [];
for (const [key, value] of Object.entries(locations)) {
	if (value.category === "BADGE") {
		hiddenBy["badges"].push(key);
	}
	else if (value.category === "HM") {
		hiddenBy["hms"].push(key);
	}
	else if (value.category === "KEY") {
		hiddenBy["key_items"].push(key);
	}
	else if (value.category === "BIKE") {
		hiddenBy["bikes"].push(key);
	}
	else if (value.category === "TICKET") {
		hiddenBy["event_tickets"].push(key);
	}
	else if (value.category === "ROD") {
		hiddenBy["rods"].push(key);
	}
	else if (value.category === "OVERWORLD_ITEM") {
		hiddenBy["overworld_items"].push(key);
	}
	else if (value.category === "HIDDEN_ITEM") {
		hiddenBy["hidden_items"].push(key);
	}
	else if (value.category === "GIFT") {
		hiddenBy["npc_gifts"].push(key);
	}
	else if (value.category === "BERRY_TREE") {
		hiddenBy["berry_trees"].push(key);
	}
}
